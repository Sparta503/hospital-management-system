...
const SmallBarChart = () => {
  ...
  const options = useMemo(() => ({
    ...
    fill: {
      ...
      // Use custom gradient for gloss effect
    },
    states: {
  ...
  return (
    <div style={{ width: 300, height: 420, paddingBottom: 24 }} className="flex flex-col items-center">
      <div className="font-semibold text-blue-700 text-sm mb-2">Appointments (This Week)</div>
